  ...
  coalesce(
    json_agg(
      ...
      ORDER BY
        ...
        "root.pg.created_on" DESC NULLS LAST
    ),
    '[]'
  ) AS "root"
FROM
  (
    SELECT
      "_1_root.base"."created_on" AS "root.pg.created_on",
            ...
            (
              SELECT
                ...
                "public"."can_book_it_now"(
                  "_1_root.base",
                  ('48b920a2-693c-ea11-aa56-a49da4eaf4ff') :: uuid
                ) AS "canBookItNow",
          ...
          (
            (
              (
                ...
                ) < (('2021-04-10') :: timestamp)
              )
              AND (
                (
                  "_0_get_loads_with_extra_data_v3"."origin_earlytime"
                ) >= (('2021-02-23') :: timestamp)
              )
            )
            AND (
              (
